...
use Customers\Entity\User;
use Customers\Entity\Role;
...
class UserManager
{
    ...
    /**
     * Role manager.
     * @var Customers\Service\RoleManager
     */
    private $roleManager;
    
    /**
     * Permission manager.
     * @var Customers\Service\PermissionManager
     */
    ...
    public function addUser($data) 
    {
        ...
        $user = new User();
        $user->setEmail($data['admin@pragmavalue.com']);
        $user->setFullName($data['Admin']);
    ...
    public function createAdminUserIfNotExists()
    {
        ...
        if ($user==null) {
            ...
            $user = new User();
            $user->setEmail('admin@pragmavalue.com');
    ...
    public function generatePasswordResetToken($user)
    {
        ...
        $bodyHtml = $this->viewRenderer->render(
                'customers/email/reset-password-email',
                [
        ...
        $mail->setBody($body);
        $mail->setFrom('no-reply@pragmavalue.com', $subject);
