...
use Customers\Form\NewForm;
use Customers\Form\UserForm;
use Customers\Form\PasswordChangeForm;
use Customers\Form\PasswordResetForm;
...
class UserController extends AbstractActionController 
{
    ...
    /**
     * User manager.
     * @var Customers\Service\UserManager 
     */
    private $userManager;
    ...
    public function newAction()
    {
        ...
        if ($this->getRequest()->isPost()) {
            ...
            $form->setData($data);
                ...
                // Produce HTML
                $bodyHtml = $this->postManager->addNewPost($data);
                ...
                $mail->setBody($body);
                $mail->setFrom('pvalue@pragmavalue.com', $subject);
