...
class Role
{
    ...
    /**
     * @ORM\ManyToMany(targetEntity="Customers\Entity\Role", inversedBy="childRoles")
    ...
    /**
     * @ORM\ManyToMany(targetEntity="Customers\Entity\Role", mappedBy="parentRoles")
     * @ORM\JoinTable(name="role_hierarchy",
    ...
    /**
     * @ORM\ManyToMany(targetEntity="Customers\Entity\Permission", inversedBy="roles")
